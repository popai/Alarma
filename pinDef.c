...
void pinSetUp()
{
	//DDRC  = 0b00001111; // PC0, PC1, PC2 OUT for keybord; PC3 OUT Buzer; PC4 and PC5 IN pins DELL and DEBUG
	//PORTC = 0b11111000;
	...
	//DDRD = 0b10000010; // PD2 senzor intarziat PD3, PD4, PD5 senzori rapizi, PD7 OUT sirena
	//PORTD = 0b01111101;
	DDRD |= (1 << DDD1) | (1 << DDD7);
